    ...
    <>
      ...
      <div className="absolute w-[274px] h-[274px] opacity-[60%] z-[1] rounded-[100px] bg-[#0066FF] blur-[150px] left-[-8%] animate-pulse top-[4%]"></div>
        <img
          src={UtilityLayer}
          alt="UtilityLayer"
          className="absolute top-0 left-0 h-full w-full mix-blend-lighten z-[-1]"
        />
        <div className="container lg:max-w-[1164px] lg:px-3 px-5 mx-auto">
          ...
          <div className="border border-[#0066FF] backdrop-blur-md bg-[#ffffff00] rounded-[32px] xl:px-[60px] sm:px-7 px-3 sm:py-0 py-5 xl:h-[740px] lg:h-[680px] sm:h-[500px] items-center relative overflow-hidden" data-aos="zoom-in">
            ...
            <div className="flex flex-row flex-wrap h-full items-center">
              <div className="xl:w-[39%] lg:w-[45%] w-full relative z-[1]">
                <h3 className="sm:w-[58px] sm:h-[58px] w-[45px] h-[45px] sm:text-[32px] text-[26px] rounded-[50%] bg-white shadow-[inset_2px_3px_12px_rgba(0,102,255,0.61)] flex justify-center items-center text-[#0066FF] font-semibold">
                  1
                </h3>
                <h4 className="ff_play font-normal md:text-[32px] sm:text-[28px] text-[24px] text-white md:leading-[129%] lg:mt-[30px] sm:mt-4 my-1">
