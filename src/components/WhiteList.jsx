...
const WhiteList = () => {
  return (
    <>
      <div className="desktop:pt-[80px] pt-10 relative">
      ...
      <div className="absolute w-[274px] h-[274px] opacity-[60%] z-[1] rounded-[100px] bg-[#0066FF] blur-[150px] right-[-8%] animate-pulse top-[-20%]"></div>
        <div className="container lg:max-w-[1164px] mx-auto lg:px-3 px-5">
          <div className="flex flex-wrap flex-row items-center lg:justify-between justify-center">
            ...
            <div className="xl:w-[42%] lg:w-[47%] w-full">
              <h3 className="ff_play font-normal xl:text-[48px] md:text-[42px] sm:text-[32px] text-[28px] sm:leading-[125.5%] leading-[100%] text-[#FCFCFC] xl:mb-4 mb-3 max-lg:text-center" data-aos="zoom-in-left">Whitelist & Presale</h3>
